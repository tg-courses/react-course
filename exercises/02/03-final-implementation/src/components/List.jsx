...
export default function List({
    ...
    const focusedSongIdRef = React.useRef(null);
    ...
    const listItems = songs.map((song, index) => {
        ...
        if (updateMessages && updateMessages[song.id]) {
            ...
            songDisplay = (
                <input
                    ref={(inputElement) => {
                        if (!focusedSongIdRef.current || !inputElement) {
                            return;
                        }

                        const selector =
                            '[data-song-id="' + focusedSongIdRef.current + '"]';

                        if (inputElement.closest(selector)) {
                            inputElement.focus();
                            focusedSongIdRef.current = null;
                        }
                    }}
                    ...
                    {isSongActive ? (
                        ...
                        <button
                            onClick={() => {
                                ...
                                focusedSongIdRef.current = song.id;
                            }}
                            disabled={isSongLocked}
                            className="button item-action-button"
                        >
